...
use Config\Services;
	...
	function certificado_autorizacion($certificado_nro){
        ...
        if ($db->simpleQuery($sql3)){
		    ...
		    $sPara = $fila_usuario->email;
		    $sAsunto = "AMC ha generado el certificado ".$certificado_nro;
		    $sTexto = "AMC Laboratorios ha generado el certificado ".$certificado_nro." y se encuentra disponible  en el siguiente link <br> 
		        <a href='http://www.amc-laboratorios.com/amc_analisis/index.php/Invitado_certificado/descarga/".$certificado[0]->clave_documento_final."' target='_blank'>Link de descarga</a>
		        <br> si no funciona copie y pegue el link en el navegador <br>
		        http://www.amc-laboratorios.com/amc_analisis/index.php/Invitado_certificado/descarga/".$certificado[0]->clave_documento_final;
