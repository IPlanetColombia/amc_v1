			...
			<div id="campo_logo" align="right">
	            ...
	            <table width="100%" border="1" cellpadding="0" cellspacing="0" class="centered border">
	                <thead>
	                    <tr>
                            <?php if ($pdf): ?>
	                           <?= $pdf ? '<td': '<th' ?> width="170"><img src="assets/img/logo_1.png" width="150" height="40" /><?= $pdf ? '</td>': '</th>' ?>
                            <?php else: ?> 
                               <?= $pdf ? '<td': '<th' ?> width="170"><img src="<?= base_url() ?>/assets/img/logo_1.png" width="150" height="40" /><?= $pdf ? '</td>': '</th>' ?>
                            <?php endif ?>
	                        <?= $pdf ? '<td': '<th' ?>><b><h1>Reporte de Ensayo 2</h1></b><?= $pdf ? '</td>': '</th>' ?>
	                        <?= $pdf ? '<td': '<th' ?> width="170"><h2 align="center">AMC - EI - FT - 01<br>Versi&oacute;n 03</h2><?= $pdf ? '</td>': '</th>' ?>
	                    </tr>
	                </thead>
	            </table>
	        </div>
	...
	<div class="row">
		<div class="col s12 l12">
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
				<thead>
			    	<tr>
			    		<td colspan="4" ><br><h2> <?= $aux_mensaje ?> No. AMC - <?= $certificado->certificado_nro ?> </h2><br></td>
			    	</tr>
			    </thead>
			    <tbody>
				    <tr>
