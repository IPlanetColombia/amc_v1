    ...
    <form method="POST" id="myform" autocomplete="off" action="<?= base_url(['funcionario', 'remisiones', 'edit', 'muestra']) ?>">
        <div class="row">
            <div class="col s12 l7">
                <div class="row">
                    <div class="input-field col s12 certificado_editar">
                        <input type="text" name="frm_certificados_editar" id="frm_certificados_editar" class="autocomplete validate">
                        <label for="frm_certificados_editar">Seleccione certificado a editar</label>
                        <small class="grey-text text-darken-4">
                            Autocompletado disponible desde el certificado # <?= $ultimo ?> hasta el certificado # <?= $primero  ?>
                        </small>
                    </div>
                </div>
            </div>
            <div class="input-field col s12 l5 centrar_button">
