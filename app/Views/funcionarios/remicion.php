    ...
    <ul class="collapsible popout">
        <li class="active">
            ...
            <div class="collapsible-body">
                <div class="row">
                    <div class="col s12">
                        <form action="<?= base_url(['funcionario','remiciones','empresa']) ?>" method="POST" id="frm_form" autocomplete="off">
                                ...
                                <div class="col s12">
                                    <div class="row">
                                        <div class="input-field col l4 s12 empresa">
                                            <input onblur="empresa_blur()" id="frm_nombre_empresa" name="frm_nombre_empresa" type="text" class="validate autocomplete frm_nombre_empresa">
                                        ...
                                        <div class="input-field col l6 s12 nit">
                                            <input id="frm_nit" name="frm_nit" type="text" class="validate">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-field col l4 s12">
                                            <input name="frm_fecha_muestra" id="frm_fecha_muestra" type="date" class="validate" value="<?= date('Y-m-d') ?>">
                                            <label for="frm_fecha_muestra">Fecha de muestreo</label>
                                        </div>
                                        <div class="input-field col l2 s12 hora">
                                            <input name="frm_hora_muestra" id="frm_hora_muestra" type="text" class="validate" value="<?=date('H:i:s')?>">
    ...
    <ul class="collapsible popout">
        <li class="active">
            ...
            <div class="collapsible-body">
                <div class="row">
                    <div class="col s12">
                        <form action="<?= base_url(['funcionario','remiciones','muestra']) ?>" method="POST" id="frm_form_muestra" autocomplete="off">
                            <div class="row">
                                <div class="input-field col l4 s12">
                        ...
                        <form id="frm_form_pie" method="POST" action="<?= base_url(['funcionario','remiciones','muestra']) ?>" autocomplete="off">
                            <div class="row">
                            ...
                            <div class="row boton_guardar_remicion">
                            </div>
                        </form>
                    </div>
                </div>
...
<?php if (isset($muestreo_verifica[0])): ?>
    ...
    <script type="text/javascript">
        ...
        $('#frm_fecha_muestra').val("<?= $muestreo_verifica[0]->mue_fecha_muestreo ?>");
